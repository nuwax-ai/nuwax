...
| 三级菜单 | 路由 | 页面文件 | 状态 |
| --- | --- | --- | --- |
| 支付配置 | `/system/payment-earnings/config` | `PaymentEarnings/Config/` | 🔲 骨架页面 |
| 支付进件信息 | `/system/payment-earnings/merchant-info` | `PaymentEarnings/MerchantInfo/` | 🔲 骨架页面 |
| 开发者付款信息 | `/system/payment-earnings/dev-payment` | `PaymentEarnings/DevPayment/` | 🔲 骨架页面 |
| 开发者收益统计 | `/system/payment-earnings/earnings-stats` | `PaymentEarnings/EarningsStats/` | ✅ 统计卡片 + 收益表格 + Mock |
| 开发者提现管理 | `/system/payment-earnings/withdrawal` | `PaymentEarnings/Withdrawal/` | 🔲 骨架页面 |
| 支付订单查询 | `/system/payment-earnings/orders` | `PaymentEarnings/Orders/` | 🔲 骨架页面 |

#### 5.5.2 订阅与积分（管理员） — 三级子菜单

| 三级菜单 | 路由 | 页面文件 | 状态 |
| --- | --- | --- | --- |
| 基础配置 | `/system/subscription-credits/basic-config` | `SubscriptionCredits/BasicConfig/` | 🔲 骨架页面 |
| 基础订阅套餐 | `/system/subscription-credits/plans` | `SubscriptionCredits/Plans/` | ✅ 统计卡片 + 订阅表格 + Mock |
| 积分增购套餐 | `/system/subscription-credits/credit-packages` | `SubscriptionCredits/CreditPackages/` | 🔲 骨架页面 |
| 用户积分查询 | `/system/subscription-credits/user-credits` | `SubscriptionCredits/UserCredits/` | 🔲 骨架页面 |
| 积分明细查询 | `/system/subscription-credits/credit-records` | `SubscriptionCredits/CreditRecords/` | 🔲 骨架页面 |
| 业务订单查询 | `/system/subscription-credits/orders` | `SubscriptionCredits/Orders/` | 🔲 骨架页面 |
...
| `src/pages/SystemManagement/PaymentEarnings/Config/` | **新页面** — 支付配置（骨架页） |
| `src/pages/SystemManagement/PaymentEarnings/MerchantInfo/` | **新页面** — 支付进件信息（骨架页） |
| `src/pages/SystemManagement/PaymentEarnings/DevPayment/` | **新页面** — 开发者付款信息（骨架页） |
| `src/pages/SystemManagement/PaymentEarnings/Withdrawal/` | **新页面** — 开发者提现管理（骨架页） |
| `src/pages/SystemManagement/PaymentEarnings/Orders/` | **新页面** — 支付订单查询（骨架页） |
| `src/pages/SystemManagement/SubscriptionCredits/` | **父目录** — 订阅与积分（管理员）三级子页面 |
| `src/pages/SystemManagement/SubscriptionCredits/Plans/` | **新页面** — 基础订阅套餐（统计卡片 + 订阅表格 + Mock 数据） |
| `src/pages/SystemManagement/SubscriptionCredits/BasicConfig/` | **新页面** — 基础配置（骨架页） |
| `src/pages/SystemManagement/SubscriptionCredits/CreditPackages/` | **新页面** — 积分增购套餐（骨架页） |
| `src/pages/SystemManagement/SubscriptionCredits/UserCredits/` | **新页面** — 用户积分查询（骨架页） |
| `src/pages/SystemManagement/SubscriptionCredits/CreditRecords/` | **新页面** — 积分明细查询（骨架页） |
| `src/pages/SystemManagement/SubscriptionCredits/Orders/` | **新页面** — 业务订单查询（骨架页） |
...
- [ ] 支付与收益下 5 个待开发三级页面：支付配置、支付进件信息、开发者付款信息、开发者提现管理、支付订单查询
- [ ] 订阅与积分下 5 个待开发三级页面：基础配置、积分增购套餐、用户积分查询、积分明细查询、业务订单查询
