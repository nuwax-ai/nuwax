"use strict";(self.webpackChunknuwax_frontend=self.webpackChunknuwax_frontend||[]).push([[3598],{631752:function(B,C,n){n.d(C,{A:function(){return u}});var E=n(607802);function u(c,t){c.accDescr&&t.setAccDescription?.(c.accDescr),c.accTitle&&t.setAccTitle?.(c.accTitle),c.title&&t.setDiagramTitle?.(c.title)}(0,E.eW)(u,"populateCommonDb")},623598:function(B,C,n){n.d(C,{diagram:function(){return ee}});var E=n(631752),u=n(570095),c=n(840621),t=n(607802),G=n(718532),g=n(861820),w=t.vZ.pie,T={sections:new Map,showData:!1,config:w},h=T.sections,x=T.showData,U=structuredClone(w),K=(0,t.eW)(()=>structuredClone(U),"getConfig"),N=(0,t.eW)(()=>{h=new Map,x=T.showData,(0,t.ZH)()},"clear"),z=(0,t.eW)(({label:e,value:a})=>{h.has(e)||(h.set(e,a),t.cM.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),F=(0,t.eW)(()=>h,"getSections"),j=(0,t.eW)(e=>{x=e},"setShowData"),V=(0,t.eW)(()=>x,"getShowData"),M={getConfig:K,clear:N,setDiagramTitle:t.g2,getDiagramTitle:t.Kr,setAccTitle:t.GN,getAccTitle:t.eu,setAccDescription:t.U$,getAccDescription:t.Mx,addSection:z,getSections:F,setShowData:j,getShowData:V},H=(0,t.eW)((e,a)=>{(0,E.A)(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),Z={parse:(0,t.eW)(async e=>{const a=await(0,G.Qc)("pie",e);t.cM.debug(a),H(a,M)},"parse")},Q=(0,t.eW)(e=>`
  .pieCircle{
