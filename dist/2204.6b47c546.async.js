...
`,"getStyles"),Ie=Le},987285:function(Wt,st,L){L.d(st,{j:function(){return j}});var W=L(809130),j=(0,W.eW)((s,D,P,Q)=>{s.attr("class",P);const{width:Y,height:rt,x:F,y:V}=it(s,D);(0,W.v2)(s,rt,Y,Q);const Z=H(F,V,Y,rt,D);s.attr("viewBox",Z),W.cM.debug(`viewBox configured: ${Z} with padding: ${D}`)},"setupViewPortForSVG"),it=(0,W.eW)((s,D)=>{const P=s.node()?.getBBox()||{width:0,height:0,x:0,y:0};return{width:P.width+D*2,height:P.height+D*2,x:P.x,y:P.y}},"calculateDimensionsWithPadding"),H=(0,W.eW)((s,D,P,Q,Y)=>`${s-Y} ${D-Y} ${P} ${Q}`,"createViewBox")}}]);
