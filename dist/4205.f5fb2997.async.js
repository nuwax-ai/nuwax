...
`,"getStyles"),Pe=Ne},14313:function(Rt,et,k){k.d(et,{j:function(){return J}});var st=k(874128),I=k(653002),j=k(293287),J=(0,j.e)((E,o,P,rt)=>{E.attr("class",P);const{width:W,height:lt,x:A,y}=K(E,o);(0,st.v2)(E,lt,W,rt);const b=g(A,y,W,lt,o);E.attr("viewBox",b),I.c.debug(`viewBox configured: ${b} with padding: ${o}`)},"setupViewPortForSVG"),K=(0,j.e)((E,o)=>{const P=E.node()?.getBBox()||{width:0,height:0,x:0,y:0};return{width:P.width+o*2,height:P.height+o*2,x:P.x,y:P.y}},"calculateDimensionsWithPadding"),g=(0,j.e)((E,o,P,rt,W)=>`${E-W} ${o-W} ${P} ${rt}`,"createViewBox")},860975:function(Rt,et,k){k.d(et,{q:function(){return j}});var st=k(293287),I=k(735403),j=(0,st.e)((J,K)=>{let g;return K==="sandbox"&&(g=(0,I.Ys)("#i"+J)),(K==="sandbox"?(0,I.Ys)(g.nodes()[0].contentDocument.body):(0,I.Ys)("body")).select(`[id="${J}"]`)},"getDiagramElement")}}]);
