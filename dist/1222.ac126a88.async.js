"use strict";(self.webpackChunknuwax_frontend=self.webpackChunknuwax_frontend||[]).push([[1222],{815833:function(ut,G,P){P.d(G,{AD:function(){return Y},AE:function(){return nt},Mu:function(){return s},N6:function(){return N},O:function(){return W},kc:function(){return H},rB:function(){return B},yU:function(){return J}});var Z=P(874128),S=P(293287),w=P(12657),et=P(735403),s=(0,S.e)((E,f)=>{const k=E.append("rect");if(k.attr("x",f.x),k.attr("y",f.y),k.attr("fill",f.fill),k.attr("stroke",f.stroke),k.attr("width",f.width),k.attr("height",f.height),f.name&&k.attr("name",f.name),f.rx&&k.attr("rx",f.rx),f.ry&&k.attr("ry",f.ry),f.attrs!==void 0)for(const T in f.attrs)k.attr(T,f.attrs[T]);return f.class&&k.attr("class",f.class),k},"drawRect"),W=(0,S.e)((E,f)=>{const k={x:f.startx,y:f.starty,width:f.stopx-f.startx,height:f.stopy-f.starty,fill:f.fill,stroke:f.stroke,class:"rect"};s(E,k).lower()},"drawBackgroundRect"),J=(0,S.e)((E,f)=>{const k=f.text.replace(Z.Vw," "),T=E.append("text");T.attr("x",f.x),T.attr("y",f.y),T.attr("class","legend"),T.style("text-anchor",f.anchor),f.class&&T.attr("class",f.class);const $=T.append("tspan");return $.attr("x",f.x+f.textMargin*2),$.text(k),T},"drawText"),nt=(0,S.e)((E,f,k,T)=>{const $=E.append("image");$.attr("x",f),$.attr("y",k);const X=(0,w.N)(T);$.attr("xlink:href",X)},"drawImage"),B=(0,S.e)((E,f,k,T)=>{const $=E.append("use");$.attr("x",f),$.attr("y",k);const X=(0,w.N)(T);$.attr("xlink:href",`#${X}`)},"drawEmbeddedImage"),H=(0,S.e)(()=>({x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}),"getNoteRect"),Y=(0,S.e)(()=>({x:0,y:0,width:100,height:100,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0}),"getTextObj"),N=(0,S.e)(()=>{let E=(0,et.Ys)(".mermaidTooltip");return E.empty()&&(E=(0,et.Ys)("body").append("div").attr("class","mermaidTooltip").style("opacity",0).style("position","absolute").style("text-align","center").style("max-width","200px").style("padding","2px").style("font-size","12px").style("background","#ffffde").style("border","1px solid #333").style("border-radius","2px").style("pointer-events","none").style("z-index","100")),E},"createTooltip")},684291:function(ut,G,P){P.d(G,{G:function(){return S}});var Z=P(293287),S=(0,Z.e)(()=>`
