import { AbstractAgent, BaseEvent, Middleware, RunAgentInput, Tool } from "@ag-ui/client";
 ...
 */
declare const DEFAULT_MAX_ITERATIONS = 32;
/**
...
declare class MCPMiddleware extends Middleware {
   ...
   */
  private listingPromise;
  constructor(mcpServers?: MCPClientConfig[], options?: MCPMiddlewareOptions);
...
//#endregion
export { DEFAULT_MAX_ITERATIONS, MAX_TOOL_NAME_LENGTH, MCPClientConfig, MCPClientConfigHTTP, MCPClientConfigSSE, MCPMiddleware, MCPMiddlewareOptions, MCP_TOOL_NAME_PREFIX, ResolvedMCPTool };
