import { B as select_default, H as __name, U as log, W as setLogLevel } from "./src-DIQO5-Xv.js";
import { $ as purify, C as getDiagramLoader, E as getSiteConfig, I as reset, L as sanitizeCss, N as registerDiagram, P as registerLazyLoadedDiagrams, Q as updateSiteConfig, S as getDiagram, T as getEffectiveHtmlLabels, V as saveConfigFromInitialize, W as setConfig, X as styles_default, Z as themes_default, _ as frontMatterRegex, b as getConfig, c as configureSvgSize, g as evaluate, l as cssStyleSheetToString, m as detectors, n as addDirective, p as detectType, q as setSiteConfig, r as assignWithDepth_default, t as UnknownDiagramError, u as defaultConfig } from "./chunk-CSCIHK7Q-Ds3AiGLM.js";
import { S as isBuffer, a as decodeEntities, f as isDetailedError, g as utils_default, h as removeDirectives, i as cleanAndMerge, o as encodeEntities, v as isTypedArray, x as isArrayLike, y as isArguments } from "./chunk-5ZQYHXKU-CN0duQv0.js";
import { t as selectSvgElement } from "./chunk-WU5MYG2G-DWjf8WUf.js";
import { i as registerIconPacks, o as dedent } from "./chunk-O5CBEL6O-CmPJRTzG.js";
import "./chunk-BSJP7CBP-Dz0oBfDK.js";
import "./chunk-L5ZTLDWV-5KuLNDT6.js";
import "./chunk-NZK2D7GU-JurIlYJ0.js";
import "./chunk-3OPIFGDE-CWR0yI_f.js";
import "./chunk-KSCS5N6A-CnLKpkhn.js";
import { n as registerLayoutLoaders } from "./chunk-LZXEDZCA-D763BWCf.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-DyQ374kW.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-DjLkkimC.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-l7PCqbwD.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-jEGmB7WZ.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-DQKsk03D.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-D4Is36jk.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-26cjcPhs.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-CEWC66tA.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-BdE9Xaal.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-COcQOI4p.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-DZb_Ab3H.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-CSWC6ftW.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-D06qRWrN.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-DJ86i2tZ.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-ChUkn-Ps.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-Cea_YIWH.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-CP1wBwD3.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-CASMFMv3.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-DyZNZPwv.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-DiK1yLVm.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-Ca31Hmvx.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-LMA3HP47-C318FUhR.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-m9BQvv0b.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-B8Ks3fGW.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-By0tI6jG.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-D6t9jbxu.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-m918L-Kq.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH--fGeMjxk.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-CpS61q1y.js");
		return {
			id: id30,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-D9GisW2_.js");
		return {
			id: id31,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-V6KhIfXy.js");
		return {
			id: id32,
			diagram: diagram2
		};
...
//# sourceMappingURL=mermaid.core-CyKzZBAM.js.map