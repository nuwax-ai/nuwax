...
export async function getClientConfigList(
  ...
  try {
    const response = (await request('/api/eco/market/client/config/list', {
      method: 'POST',
      data: params,
...
export async function getClientConfigDetail(
  ...
  try {
    const response = (await request('/api/eco/market/client/config/detail', {
      method: 'POST',
      data: {
        uid,
      },
...
export async function deleteClientConfig(uid: string): Promise<boolean> {
  ...
  try {
    const response = (await request(
      `/api/eco/market/client/config/delete/${encodeURIComponent(uid.trim())}`,
      {
        method: 'DELETE',
      },
...
export async function offlineClientConfig(
  ...
  try {
    const response = (await request(
      `/api/eco/market/client/config/offline/${encodeURIComponent(uid.trim())}`,
      {
        method: 'POST',
      },
    )) as RequestResponse<ClientConfigVo>;
...
export async function createClientConfigDraft(
  ...
  try {
    const response = (await request(
      '/api/eco/market/client/config/save/draft',
      {
        method: 'POST',
        data: params,
      },
...
export async function saveAndPublishClientConfig(
  ...
  try {
    const response = (await request(
      '/api/eco/market/client/config/save/publish',
      {
        method: 'POST',
        data: params,
      },
...
export async function updateClientConfigDraft(
  ...
  try {
    const response = (await request(
      '/api/eco/market/client/config/update/draft',
      {
        method: 'POST',
        data: params,
      },
