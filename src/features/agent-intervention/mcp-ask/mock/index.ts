/**
 * MCP Ask/Question — 本地 UI 调试 Mock（对齐 nuwax-ask-question-mcp）
 */
...
/**
 * 模拟 SSE tool_call 事件（走 conversationInfo 解析链路时可使用）
 */
...
/**
 * 消息列表中是否已有开发 Mock 的 MCP Ask 交互（任意状态，避免重复注入）
 */
