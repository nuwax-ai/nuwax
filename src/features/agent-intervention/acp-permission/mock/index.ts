/**
 * ACP 权限审批卡片 — 本地 UI 调试 Mock 数据与注入工具
 * 仅用于 development 环境验证 ChatView / AcpPermissionCard 渲染与交互态
 */
...
/** localStorage：点击审批按钮时走本地模拟，不调后端 */
...
/**
 * 将 Mock 权限交互注入消息列表（默认挂到最后一条 Agent 消息）
 */
