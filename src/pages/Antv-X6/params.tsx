...
export const asideList: StencilList[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: t('PC.Pages.AntvX6Params.nodeKnowledgeInsertName'),
        icon: <ICON_WORKFLOW_KNOWLEDGE_INSERT />,
        bgIcon: BG_ICON_WORKFLOW_KNOWLEDGE_INSERT,
        type: NodeTypeEnum.KnowledgeInsert,
        shape: NodeShapeEnum.General,
        description: t('PC.Pages.AntvX6Params.nodeKnowledgeInsertDescription'),
      },
      {
