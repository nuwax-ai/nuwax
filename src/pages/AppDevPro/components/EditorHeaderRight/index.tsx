...
import AppDevSettingsModal from '../AppDevSettingsModal';
...
const SettingsButton: React.FC<SettingsButtonProps> = ({
  ...
  return (
    <>
      <Tooltip title={t('PC.Pages.AppDevEditorHeaderRight.settings')}>
        <Button
          type="text"
...
const EditorHeaderRight: React.FC<EditorHeaderRightProps> = ({
  ...
  return (
    <div className={styles.editorHeaderRight}>
      ...
      {/* 项目设置按钮 - 始终显示 */}
      <SettingsButton
        projectInfo={settingsData?.projectInfo}
        onSuccess={settingsData?.onSuccess}
        disabled={settingsData?.disabled || isChatLoading}
      />
