  ...
  const { run: runGetDataPermission } = useRequest(getDataPermissionApi, {
    ...
    onSuccess: (result: DataPermission) => {
      ...
      const formData = {
        ...
        agentComputerStorageLimitGb: result.agentComputerStorageLimitGb ?? -1,
        pageAppStorageLimitGb: result.pageAppStorageLimitGb ?? -1,
  ...
  useEffect(() => {
    if (open) {
      ...
      const defaultFormValues = {
        ...
        agentComputerStorageLimitGb: -1,
        pageAppStorageLimitGb: -1,
