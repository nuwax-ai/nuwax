...
export interface ThemeStyleConfig {
  ...
  layout: {
    ...
    '--xagi-layout-second-menu-adaptive-text': string;
    '--xagi-layout-second-menu-adaptive-text-secondary': string;
    '--xagi-layout-second-menu-adaptive-text-tertiary': string;
