...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Pages.AgentFlowNode.agentIdEmpty": "暫無智能體",
  "PC.Pages.AgentFlowNode.extraPromptLabel": "補充提示詞",
  "PC.Pages.AgentFlowNode.extraPromptPlaceholder": "可新增提示詞約束智能體輸出格式...",
  "PC.Pages.AgentFlowNode.extraPromptTooltip": "約束輸出格式等，支援 {{變數}} 參照",
  "PC.Pages.AgentFlowNode.reminderPromptLabel": "循環提醒提示詞",
  "PC.Pages.AgentFlowNode.reminderPromptPlaceholder": "循環提醒提示詞...",
  "PC.Pages.AgentFlowNode.reminderPromptTooltip": "每次自循環結束後注入的提醒提示詞，支援 {{變數}} 參照",
  "PC.Pages.AgentFlowNode.selfLoopTimesLabel": "自身循環次數",
  "PC.Pages.AgentFlowNode.selfLoopTimesTooltip": "智能體自循環執行的次數，0 表示不循環",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionLabel": "條件比對",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionPlaceholder": "輸入條件比對運算式，支援 {{變數}} 參照",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionTooltip": "用於精確比對的條件運算式，如 {{var}} == value",
