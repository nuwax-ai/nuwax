...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Pages.AppDevPro.databaseDev": "開發環境資料庫",
  "PC.Pages.AppDevPro.databaseDevConfig": "開發環境資料庫設定",
  "PC.Pages.AppDevPro.databaseProd": "線上環境資料庫",
  "PC.Pages.AppDevPro.databaseProdConfig": "線上環境資料庫設定",
  "PC.Pages.AppDevPro.databaseConfigDesc": "查看和設定目前環境的資料庫帳號和密碼",
  "PC.Pages.AppDevPro.databaseProdDesc": "檢視和管理線上環境資料庫",
  "PC.Pages.AppDevPro.databaseProdConfigDesc": "查看和設定線上環境的資料庫帳號和密碼",
  ...
  "PC.Pages.AppDevPro.prodContainerStarting": "正在啟動線上環境...",
  "PC.Pages.AppDevPro.prodContainerFailed": "線上環境啟動失敗",
  ...
  "PC.Pages.AppDevPro.publishToMarketStep": "發佈應用到廣場",
  "PC.Pages.AppDevPro.publishToMarketHint": "請完成發佈到廣場",
  "PC.Pages.AppDevPro.reopenPublishToMarket": "繼續發佈到廣場",
  "PC.Pages.AppDevPro.publishToSquareNote": "（已部署成功，使用者可自行決定是否需要發佈到廣場）",
  ...
  // 全栈应用设置页
  // 顶部 Tab
  "PC.Pages.AppProjectSetting.tabPlan": "計畫",
  ...
  "PC.Pages.AppProjectSetting.oauthDesc": "平台已為該專案自動產生 OAuth2 憑證，可用於第三方登入與介面鑑權。Client Secret 屬於敏感資訊，請勿寫入前端或提交到公開倉庫。",
  ...
  // 空态与提示
  "PC.Pages.AppProjectSetting.notFound": "找不到該專案",
  "PC.Pages.AppProjectSetting.untitled": "未命名專案",
