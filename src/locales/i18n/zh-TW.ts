...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Chat.LocalFiles.workspaceLabel": "專案目錄",
  ...
  "PC.Chat.LocalFiles.workspaceListFailed": "專案目錄讀取失敗",
  "PC.Chat.LocalFiles.nameExists": "同名檔案或目錄已存在",
  "PC.Chat.LocalFiles.deleteTitle": "刪除確認",
  "PC.Chat.LocalFiles.deleteWarning": "將在會話電腦上永久刪除「{name}」，此操作無法復原（不進入回收站）。",
  "PC.Chat.LocalFiles.deleteConfirm": "刪除",
  "PC.Chat.LocalFiles.saveFailed": "儲存失敗",
  "PC.Chat.LocalFiles.upToParent": "返回上一層目錄",
