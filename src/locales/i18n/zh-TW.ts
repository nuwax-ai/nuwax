...
export const ZH_TW: SystemLangMap = {
  ...
  'PC.Components.AcpPermissionCard.eyebrow': 'ACP 權限審批',
  'PC.Components.AcpPermissionCard.rawInput': '原始輸入',
  'PC.Components.AcpPermissionCard.saveRule': '儲存為規則',
  'PC.Components.AcpPermissionCard.submitted': '已提交審批結果',
  'PC.Components.AcpPermissionCard.toolCallId': '工具呼叫 ID',
