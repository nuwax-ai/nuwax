...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Pages.ConversationAgentPreviewTabBar.theme": "切換主題",
  "PC.Pages.ConversationAgentPreviewTabBar.sourceControl": "原始碼管理",
  "PC.Pages.ConversationAgentPreviewTabBar.splitView": "分屏",
  "PC.Pages.ConversationAgentPreviewTabBar.openExternal": "在外部開啟",
  ...
  "PC.Pages.ConversationAgentTabPicker.integratedServices": "整合服務",
  "PC.Pages.ConversationAgentTabPicker.integratedServicesDesc": "快速配置資料庫、身份驗證、儲存等後端基礎設施，為應用賦能底層能力。",
  "PC.Pages.ConversationAgentTabPicker.hosting": "託管",
  "PC.Pages.ConversationAgentTabPicker.hostingDesc": "一鍵部署應用到生產環境，提供即時資料監控和日誌排查服務。",
  ...
  "PC.Pages.ConversationAgentTabPicker.integrationMgmt": "整合管理",
  "PC.Pages.ConversationAgentTabPicker.integrationMgmtDesc": "配置模型能力、外部 API 和專案所需的各類後端服務資源。",
  "PC.Pages.ConversationAgentTabPicker.envVars": "環境變數",
  "PC.Pages.ConversationAgentTabPicker.envVarsDesc": "安全儲存 API Key 等配置資訊。",
  "PC.Pages.ConversationAgentTabPicker.database": "資料庫",
  "PC.Pages.ConversationAgentTabPicker.databaseDesc": "查看和管理專案中的結構化資料。",
  "PC.Pages.ConversationAgentTabPicker.auth": "身份驗證",
  "PC.Pages.ConversationAgentTabPicker.authDesc": "快速配置使用者登入、註冊和權限管理。",
  "PC.Pages.ConversationAgentTabPicker.objectStorage": "物件儲存",
  "PC.Pages.ConversationAgentTabPicker.objectStorageDesc": "儲存圖片、影片、文件等非結構化檔案資源。",
