...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Pages.SpaceCreateProject.placeholderAgent": "描述你想要的智能體，例如：幫我創建一個程式碼審查助手，能自動檢測程式碼問題並給出優化建議",
  "PC.Pages.SpaceCreateProject.tabPageApp": "網頁應用",
  "PC.Pages.SpaceCreateProject.placeholderPageApp": "描述你想要的網頁應用，例如：幫我開發一個顏值管理網站，支援上傳照片智慧評估顏值與膚質",
  "PC.Pages.SpaceCreateProject.tabSkill": "技能",
  "PC.Pages.SpaceCreateProject.placeholderSkill": "描述你想要的自訂技能，例如：幫我寫一個根據經緯度查詢目前天氣狀況的API介面",
