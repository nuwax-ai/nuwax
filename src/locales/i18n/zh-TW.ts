...
export const ZH_TW: SystemLangMap = {
  ...
  "PC.Components.ChatInputCommands.hint": "直接輸入指令，Shift+Enter 換行，Enter 傳送；輸入 / 選擇技能或外掛；支援貼上圖片",
  ...
  "PC.Pages.AppDevPro.cancelPublishContent": "取消後將停止目前建置任務，不會提交發佈申請",
  "PC.Pages.AppDevPro.cancelPublishTitle": "確認取消發佈？",
  ...
  "PC.Components.LocalFiles.workspaceLabel": "專案目錄",
  ...
  "PC.Components.LocalFiles.deleteWarning": "將在會話電腦上永久刪除「{name}」，此操作無法復原（不進入回收站）。",
