...
export const EN_US: SystemLangMap = {
  ...
  "PC.Pages.AgentFlowNode.agentIdEmpty": "No agent available",
  ...
  "PC.Pages.AgentFlowNode.extraPromptTooltip": "Constrain output format, etc. Supports {{variable}} references",
  ...
  "PC.Pages.AgentFlowNode.reminderPromptTooltip": "Reminder prompt injected after each self-loop; supports {{variable}} references",
  ...
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionLabel": "Condition Match",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionPlaceholder": "Enter a condition expression; supports {{variable}} references",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionTooltip": "Condition expression for exact matching, e.g. {{var}} == value",
