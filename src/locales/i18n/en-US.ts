...
export const EN_US: SystemLangMap = {
  ...
  "PC.Pages.AppDevSettingsModal.reusePlatformAuth": "Reuse platform authentication",
  "PC.Pages.AppDevSettingsModal.reusePlatformAuthDesc": "After enabling, you can get the current user's uid, username, and nickname from the header for unique identification.",
