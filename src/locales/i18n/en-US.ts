...
export const EN_US: SystemLangMap = {
  ...
  "PC.App.chunkLoadErrorContent": "Failed to load page resources. Please refresh and try again.",
  "PC.App.chunkLoadErrorRefresh": "Refresh Now",
  "PC.App.chunkLoadErrorTitle": "Page Load Error",
