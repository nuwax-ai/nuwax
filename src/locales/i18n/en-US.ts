...
export const EN_US: SystemLangMap = {
  ...
  "PC.Pages.SpaceCreateProject.greetingTitle": "Hi, {0}, give me a task to start now?",
  "PC.Pages.SpaceCreateProject.tabAgent": "Agent",
  "PC.Pages.SpaceCreateProject.placeholderAgent": "Describe the agent you want, e.g., help me create a code review assistant that automatically detects issues and provides optimization suggestions.",
  "PC.Pages.SpaceCreateProject.tabPageApp": "Web App",
  "PC.Pages.SpaceCreateProject.placeholderPageApp": "Describe the web app you want, e.g., help me develop a beauty rating website that supports uploading photos to intelligently evaluate beauty and skin quality.",
  "PC.Pages.SpaceCreateProject.tabSkill": "Skill",
  "PC.Pages.SpaceCreateProject.placeholderSkill": "Describe the custom skill you want, e.g., help me write an API endpoint to query the current weather based on coordinates.",
  "PC.Pages.SpaceCreateProject.tabPlugin": "Plugin",
  "PC.Pages.SpaceCreateProject.placeholderPlugin": "Describe the plugin tool you want, e.g., help me integrate a third-party image conversion HTTP plugin.",
  "PC.Pages.SpaceCreateProject.inputRequiredWarning": "Please input your task description!",
