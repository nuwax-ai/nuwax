...
export const EN_US: SystemLangMap = {
  ...
  "PC.Components.ChatInputHome.atContext": "Use @ to add context",
  "PC.Components.ChatInputHome.slashCapability": "Use / to select capabilities",
  ...
  "PC.Components.ChatInputCommands.hint": "Enter commands, Shift+Enter for a new line, Enter to send; type / to add capabilities, @ to reference files; paste images.",
  ...
  "PC.Pages.AppDevPro.databaseDev": "Development database",
  "PC.Pages.AppDevPro.databaseDevConfig": "Development database settings",
  "PC.Pages.AppDevPro.databaseProd": "Online database",
  "PC.Pages.AppDevPro.databaseProdConfig": "Online database settings",
  "PC.Pages.AppDevPro.databaseConfigDesc": "View and configure the database username and password for the current environment",
  "PC.Pages.AppDevPro.databaseProdDesc": "View and manage the online environment database",
  "PC.Pages.AppDevPro.databaseProdConfigDesc": "View and configure the online database username and password",
  ...
  "PC.Pages.AppDevPro.prodContainerStarting": "Starting the online environment...",
  "PC.Pages.AppDevPro.prodContainerFailed": "Failed to start the online environment",
  "PC.Pages.AppDevPro.prodContainerRetry": "Retry",
  ...
  "PC.Pages.AppDevPro.publishToMarketStep": "Publish to square",
  "PC.Pages.AppDevPro.publishToMarketHint": "Please finish publishing to the square",
  "PC.Pages.AppDevPro.reopenPublishToMarket": "Continue publishing to square",
  "PC.Pages.AppDevPro.publishToSquareNote": "(Deployed. You can decide whether to publish to the square.)",
  ...
  "PC.Pages.AppDevPro.restartService": "Restart service",
  ...
  // 全栈应用设置页
  // 顶部 Tab
  "PC.Pages.AppProjectSetting.tabPlan": "Plan",
  "PC.Pages.AppProjectSetting.tabAsset": "Assets",
  "PC.Pages.AppProjectSetting.tabSetting": "Settings",
  "PC.Pages.AppProjectSetting.comingSoon": "Coming soon",
  // OAuth2 认证
  "PC.Pages.AppProjectSetting.oauthTitle": "OAuth2 credentials",
  "PC.Pages.AppProjectSetting.oauthDesc": "The platform generated OAuth2 credentials for this project. They can be used for third-party sign-in and API auth. Keep the Client Secret private and never commit it to a public repo.",
  "PC.Pages.AppProjectSetting.clientId": "Client ID",
  "PC.Pages.AppProjectSetting.clientSecret": "Client Secret",
  "PC.Pages.AppProjectSetting.homeUrl": "Homepage URL",
  "PC.Pages.AppProjectSetting.homeUrlPlaceholder": "Enter homepage URL",
  "PC.Pages.AppProjectSetting.callbackUrl": "Callback URL",
  "PC.Pages.AppProjectSetting.callbackUrlPlaceholder": "Enter callback URL",
  "PC.Pages.AppProjectSetting.regenerate": "Regenerate credentials",
  "PC.Pages.AppProjectSetting.regenerateHint": "Old credentials become invalid immediately. Update connected apps after regenerating.",
  "PC.Pages.AppProjectSetting.regenerateConfirmTitle": "Regenerate credentials?",
  "PC.Pages.AppProjectSetting.regenerateSuccess": "Credentials regenerated",
  "PC.Pages.AppProjectSetting.regenerateUnavailable": "Regenerating credentials is not available yet",
  // 域名绑定
  "PC.Pages.AppProjectSetting.domainTitle": "Domain binding",
  "PC.Pages.AppProjectSetting.domainDesc": "After binding your own domain, published apps can be opened from it. Add a CNAME record pointing to {0}. The status updates after DNS resolves.",
  "PC.Pages.AppProjectSetting.cnameLabel": "CNAME",
  "PC.Pages.AppProjectSetting.copyCname": "Copy CNAME",
  "PC.Pages.AppProjectSetting.bindDomain": "Bind domain",
  "PC.Pages.AppProjectSetting.domainPlaceholder": "Enter a domain, e.g. app.example.com",
  "PC.Pages.AppProjectSetting.domainBound": "Bound",
  // 发布服务器配置
  "PC.Pages.AppProjectSetting.deployTitle": "Publish server",
  "PC.Pages.AppProjectSetting.deployDesc": "Choose where the app runs after publish. A private server requires the protocol, server address, and two ports.",
  "PC.Pages.AppProjectSetting.platformService": "Platform service",
  "PC.Pages.AppProjectSetting.platformServiceDesc": "Hosted by Nuwa with autoscaling and no ops overhead",
  "PC.Pages.AppProjectSetting.privateServer": "Private server",
  "PC.Pages.AppProjectSetting.privateServerDesc": "Deploy to your own server. Configure protocol, IP, and two ports",
  "PC.Pages.AppProjectSetting.platformHint": "Currently hosted by the platform. No server details are required. Switch to a private server to configure protocol, IP, and ports.",
  "PC.Pages.AppProjectSetting.protocol": "Protocol",
  "PC.Pages.AppProjectSetting.protocolHttp": "http",
  "PC.Pages.AppProjectSetting.protocolHttps": "https",
  "PC.Pages.AppProjectSetting.serverIp": "Server IP",
  "PC.Pages.AppProjectSetting.serverIpPlaceholder": "e.g. 47.98.12.34",
  "PC.Pages.AppProjectSetting.appPort": "App port",
  "PC.Pages.AppProjectSetting.appPortPlaceholder": "e.g. 8080",
  "PC.Pages.AppProjectSetting.managePort": "Manage port",
  "PC.Pages.AppProjectSetting.managePortPlaceholder": "e.g. 8081",
  "PC.Pages.AppProjectSetting.privateHint": "The app port is for public access. The manage port is for platform deploy and health checks. Make sure the server is reachable and both ports are open. For HTTPS, install a valid certificate on the app port. The platform does not manage certificates.",
  // 相关任务
  ...
  "PC.Pages.AppProjectSetting.untitled": "Untitled project",
  "PC.Pages.AppProjectSetting.emptyValue": "—",
  "PC.Pages.AppProjectSetting.bindSuccess": "Domain bound",
  "PC.Pages.AppProjectSetting.unbindSuccess": "Domain unbound",
  ...
  "PC.Pages.AppProjectSetting.addPrivateServer": "Add private server",
  "PC.Pages.AppProjectSetting.addServerRow": "Add",
  "PC.Pages.AppProjectSetting.addPrivateServerSuccess": "Private server added",
  "PC.Pages.AppProjectSetting.deletePrivateServerTitle": "Delete private server",
  "PC.Pages.AppProjectSetting.deletePrivateServerContent": "Delete {0}?",
  "PC.Pages.AppProjectSetting.invalidServerIp": "Enter a server address",
  "PC.Pages.AppProjectSetting.invalidPort": "Enter a port between 1 and 65535",
  "PC.Pages.AppProjectSetting.healthOnline": "Online",
  "PC.Pages.AppProjectSetting.healthOffline": "Offline",
  ...
  'PC.Components.CapabilityModal.hintNav': '↑↓ Navigate',
  'PC.Components.CapabilityModal.hintSelect': 'Enter Select',
  'PC.Components.CapabilityModal.hintClose': 'Esc Close',
