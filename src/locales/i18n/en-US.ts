...
export const EN_US: SystemLangMap = {
  ...
  "PC.Pages.AgentFlowNode.agentModeSubFlow": "Sub Flow",
  "PC.Pages.AgentFlowNode.answerTypeSelect": "Selection",
  "PC.Pages.AgentFlowNode.answerTypeText": "Text",
  "PC.Pages.AgentFlowNode.approveActionApprove": "Approve",
  "PC.Pages.AgentFlowNode.approveActionEdit": "Edit",
  "PC.Pages.AgentFlowNode.approveActionReject": "Reject",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryContinue": "Continue",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryFail": "Fail",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryHuman": "Transfer to Human",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryLabel": "On Max Retry",
  "PC.Pages.AgentFlowNode.evalTypeLlmJudge": "LLM Judge",
  "PC.Pages.AgentFlowNode.evalTypeRule": "Rule Based",
  "PC.Pages.AgentFlowNode.hitlModeApprove": "Approval",
  "PC.Pages.AgentFlowNode.hitlModeAsk": "Ask",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptLabel": "Extra Prompt",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptPlaceholder": "Enter extra routing instructions for AI...",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptTooltip": "Additional instructions to help the AI model make better routing decisions",
  "PC.Pages.AgentFlowNode.routeDecisionRouteAdd": "Add Route Rule",
  "PC.Pages.AgentFlowNode.routeDecisionRoutesTitle": "Route Rules",
  "PC.Pages.AgentFlowNode.agentIdLabel": "Platform Agent ID",
  "PC.Pages.AgentFlowNode.agentIdPlaceholder": "Enter platform agent ID",
  "PC.Pages.AgentFlowNode.agentModeLabel": "Agent Mode",
  "PC.Pages.AgentFlowNode.approveActionsLabel": "Approval Actions",
  "PC.Pages.AgentFlowNode.approveDraftSourceLabel": "Draft Source",
  "PC.Pages.AgentFlowNode.approveDraftSourceTooltip": "Template expression for the draft content to review, e.g. {{node.<prevId>.output}}",
  "PC.Pages.AgentFlowNode.approvePromptLabel": "Prompt to Reviewer",
  "PC.Pages.AgentFlowNode.approvePromptPlaceholder": "Enter instructions for the reviewer...",
  "PC.Pages.AgentFlowNode.askAnswerKeyLabel": "Answer Key",
  "PC.Pages.AgentFlowNode.askAnswerKeyTooltip": "The context key to store the user's answer, e.g. userAnswer",
  "PC.Pages.AgentFlowNode.askAnswerTypeLabel": "Answer Type",
  "PC.Pages.AgentFlowNode.askOptionsLabel": "Options (JSON)",
  "PC.Pages.AgentFlowNode.askOptionsTooltip": "JSON array of options, e.g. [{\"index\":0,\"content\":\"Option A\",\"uuid\":\"...\"}]",
  ...
  "PC.Pages.AgentFlowNode.autoWireLabel": "Auto-wire Previous Output",
  "PC.Pages.AgentFlowNode.autoWireTooltip": "Automatically connect the previous node's output as this node's input",
  "PC.Pages.AgentFlowNode.connectorAuthCozeTooltip": "Reference a Coze API token, e.g. {{secrets.cozeToken}}",
  "PC.Pages.AgentFlowNode.connectorAuthDifyTooltip": "Reference a Dify API key, e.g. {{secrets.difyApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthN8nTooltip": "Reference an n8n API key or webhook secret, e.g. {{secrets.n8nApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthRagflowTooltip": "Reference a Ragflow API key, e.g. {{secrets.ragflowApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthRefLabel": "Auth Reference",
  "PC.Pages.AgentFlowNode.connectorAuthRefPlaceholder": "{{secrets.apiKey}}",
  "PC.Pages.AgentFlowNode.connectorEndpointLabel": "Endpoint URL",
  "PC.Pages.AgentFlowNode.connectorPayloadTemplateLabel": "Payload Template",
  "PC.Pages.AgentFlowNode.connectorPayloadTemplateTooltip": "JSON template for the request body. Use {{context.xxx}} for runtime variables.",
  "PC.Pages.AgentFlowNode.connectorProviderLabel": "Provider",
  "PC.Pages.AgentFlowNode.connectorResponseMappingAdd": "Add Response Mapping",
  ...
  "PC.Pages.AgentFlowNode.evalJudgePromptPlaceholder": "Enter the LLM judge prompt...",
  "PC.Pages.AgentFlowNode.evalJudgeThresholdLabel": "Threshold",
  "PC.Pages.AgentFlowNode.evalMaxRetryLabel": "Max Retry",
  "PC.Pages.AgentFlowNode.evalOnFailAppendPromptLabel": "Append Prompt on Fail",
  "PC.Pages.AgentFlowNode.evalOnFailAppendPromptPlaceholder": "Extra prompt appended when validation fails...",
  "PC.Pages.AgentFlowNode.evalOnFailReasonLabel": "Failure Reason",
  "PC.Pages.AgentFlowNode.evalOnFailReasonPlaceholder": "Brief reason for failure, e.g. format_invalid",
  "PC.Pages.AgentFlowNode.evalOnFailTargetLabel": "Retry Target Node",
  "PC.Pages.AgentFlowNode.evalOnFailTargetTooltip": "Node ID to jump back to for retry when validation fails",
  "PC.Pages.AgentFlowNode.evalOnFailAppendPromptLabel": "Append Prompt on Fail",
  "PC.Pages.AgentFlowNode.evalRulePatternLabel": "Rule Pattern",
  "PC.Pages.AgentFlowNode.evalRulePatternTooltip": "Regex pattern to validate against, e.g. ^ORDER-\\d+$",
  "PC.Pages.AgentFlowNode.evalValidatorAdd": "Add Validator",
  "PC.Pages.AgentFlowNode.evalValidatorIndex": "Validator #{index}",
  "PC.Pages.AgentFlowNode.evalValidatorNameLabel": "Validator Name",
  "PC.Pages.AgentFlowNode.evalValidatorNamePlaceholder": "e.g. order_format_check",
  "PC.Pages.AgentFlowNode.evalValidatorTypeLabel": "Validator Type",
  "PC.Pages.AgentFlowNode.evalValidatorsTitle": "Validators",
  "PC.Pages.AgentFlowNode.hitlModeLabel": "Interaction Mode",
  "PC.Pages.AgentFlowNode.routeDecisionRouteDescriptionLabel": "Description",
  "PC.Pages.AgentFlowNode.routeDecisionRouteDescriptionPlaceholder": "Describe when this route should be chosen...",
  "PC.Pages.AgentFlowNode.routeDecisionRouteIndex": "Route #{index}",
  "PC.Pages.AgentFlowNode.routeDecisionRouteNameLabel": "Route Name",
  ...
  "PC.Pages.AgentFlowNode.subFlowIdPlaceholder": "Enter sub flow ID",
  "PC.Pages.AgentFlowNode.agentInputsTitle": "Input Mapping",
  "PC.Pages.AgentFlowNode.agentInputsAdd": "Add Input",
  "PC.Pages.AgentFlowNode.askRequiredLabel": "Required",
  "PC.Pages.AgentFlowNode.askRequiredTooltip": "User must provide an answer before continuing",
  "PC.Pages.AgentFlowNode.approveOnRejectTargetLabel": "Reject Target Node",
  "PC.Pages.AgentFlowNode.approveOnRejectTargetTooltip": "Node ID to jump to when rejected; leave empty to fail the run",
  "PC.Pages.AgentFlowNode.approvalModeAlwaysPass": "Notify Only (Auto-pass)",
  "PC.Pages.AgentFlowNode.approvalModeApproveReject": "Approve / Reject",
  "PC.Pages.AgentFlowNode.approvalModeEditApprove": "Edit then Approve",
  "PC.Pages.AgentFlowNode.approvalModeLabel": "Approval Mode",
  "PC.Pages.AgentFlowNode.approveBranchAdd": "+ Add Branch",
  "PC.Pages.AgentFlowNode.approveBranchesTitle": "Output Branches",
  "PC.Pages.AgentFlowNode.askOptionsTitle": "Options",
  "PC.Pages.AgentFlowNode.askTimeoutLabel": "Timeout (seconds)",
  "PC.Pages.AgentFlowNode.askTimeoutPlaceholder": "Enter timeout",
  "PC.Pages.AgentFlowNode.baseParamLabel": "Base Parameter",
  "PC.Pages.AgentFlowNode.branchDescPlaceholder": "Description",
  "PC.Pages.AgentFlowNode.branchNamePlaceholder": "Branch Name",
  "PC.Pages.AgentFlowNode.channelAdd": "+ Add Channel",
  "PC.Pages.AgentFlowNode.channelRetryLabel": "Retry Count",
  "PC.Pages.AgentFlowNode.channelTimeoutLabel": "Channel Timeout (seconds)",
  "PC.Pages.AgentFlowNode.channelsTitle": "Confirmation Channels",
  "PC.Pages.AgentFlowNode.confirmRoleExternal": "External Reviewer",
  "PC.Pages.AgentFlowNode.confirmRoleLabel": "Reviewer Role",
  "PC.Pages.AgentFlowNode.confirmRoleUser": "Current User",
  "PC.Pages.AgentFlowNode.contextPassAuto": "Auto",
  "PC.Pages.AgentFlowNode.contextPassManual": "Manual",
  "PC.Pages.AgentFlowNode.contextWriteKeyHint": "Context key for output, e.g. evalResult",
  "PC.Pages.AgentFlowNode.contextPassModeLabel": "Context Passing",
  "PC.Pages.AgentFlowNode.escalationAbort": "Abort Workflow",
  "PC.Pages.AgentFlowNode.escalationLabel": "Timeout Action",
  "PC.Pages.AgentFlowNode.escalationReject": "Auto Reject",
  "PC.Pages.AgentFlowNode.escalationRetry": "Re-notify Reviewer",
  "PC.Pages.AgentFlowNode.escalationSkip": "Skip (Auto-pass)",
  "PC.Pages.AgentFlowNode.evalBranchAdd": "+ Add Fail Branch",
  "PC.Pages.AgentFlowNode.evalBranchesTitle": "Evaluation Branches",
  "PC.Pages.AgentFlowNode.evalFailMsgLabel": "Fail Message on Exceeded Retries",
  "PC.Pages.AgentFlowNode.evalFailMsgPlaceholder": "Agent output evaluation failed, please review carefully",
  "PC.Pages.AgentFlowNode.evalItemAdd": "+ Add Eval Item",
  "PC.Pages.AgentFlowNode.evalItemDescLabel": "Evaluation Criteria",
  "PC.Pages.AgentFlowNode.evalItemDescPlaceholder": "Describe evaluation criteria",
  "PC.Pages.AgentFlowNode.evalItemIndex": "Eval Item {{index}}",
  "PC.Pages.AgentFlowNode.evalItemNameLabel": "Item Name",
  "PC.Pages.AgentFlowNode.evalItemNamePlaceholder": "Accuracy",
  "PC.Pages.AgentFlowNode.evalItemsTitle": "Evaluation Items",
  "PC.Pages.AgentFlowNode.evalItemWeightLabel": "Weight",
  "PC.Pages.AgentFlowNode.evalModelLabel": "Evaluation Model",
  "PC.Pages.AgentFlowNode.evalModelPlaceholder": "Select evaluation model",
  "PC.Pages.AgentFlowNode.evalOutputLabel": "Output Evaluation Process",
  "PC.Pages.AgentFlowNode.evalWeightTotalLabel": "Total Weight",
  "PC.Pages.AgentFlowNode.extraParamsAdd": "+ Add Parameter",
  "PC.Pages.AgentFlowNode.extraParamsTitle": "Custom Parameters",
  "PC.Pages.AgentFlowNode.formFieldAdd": "+ Add Field",
  "PC.Pages.AgentFlowNode.formFieldIndex": "Field {0}",
  "PC.Pages.AgentFlowNode.formFieldLabel": "Field Label",
  "PC.Pages.AgentFlowNode.formFieldLabelPlaceholder": "Enter field label",
  "PC.Pages.AgentFlowNode.formFieldType": "Field Type",
  "PC.Pages.AgentFlowNode.formFieldOptions": "Options",
  ...
  "PC.Pages.AgentFlowNode.formTypeFile": "File",
  ...
  "PC.Pages.AgentFlowNode.instructionLabel": "Review Instructions",
  "PC.Pages.AgentFlowNode.instructionPlaceholder": "Describe what needs to be confirmed...",
  "PC.Pages.AgentFlowNode.optionAdd": "+ Add Option",
  "PC.Pages.AgentFlowNode.optionContentPlaceholder": "Enter option content",
  "PC.Pages.AgentFlowNode.passThresholdLabel": "Pass Threshold",
  "PC.Pages.AgentFlowNode.passThresholdSuffix": "pts",
  "PC.Pages.AgentFlowNode.replyModeForm": "Form",
  "PC.Pages.AgentFlowNode.replyModeLabel": "Reply Mode",
  "PC.Pages.AgentFlowNode.replyModeOptions": "Options",
  "PC.Pages.AgentFlowNode.replyModeText": "Text",
  "PC.Pages.AgentFlowNode.routeModelLabel": "Routing Model",
  "PC.Pages.AgentFlowNode.routeModelPlaceholder": "Select routing model",
  "PC.Pages.AgentFlowNode.shareContextLabel": "Share Upstream Agent Context",
  "PC.Pages.AgentFlowNode.systemPromptLabel": "System Prompt Supplement",
  "PC.Pages.AgentFlowNode.systemPromptPlaceholder": "Add prompts to constrain agent output format...",
  "PC.Pages.AgentFlowNode.systemPromptTooltip": "Constrain output format, supports {{variable}} references",
