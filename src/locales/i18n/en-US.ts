...
export const EN_US: SystemLangMap = {
  ...
  "PC.Chat.LocalFiles.workspaceLabel": "Project directory",
  "PC.Chat.LocalFiles.openLocalDirectory": "Open local directory…",
  "PC.Chat.LocalFiles.openByPathTitle": "Open local directory",
  "PC.Chat.LocalFiles.openByPathHint": "Enter the absolute directory path on the computer hosting this session",
  "PC.Chat.LocalFiles.pathPlaceholder": "e.g. /Users/me/docs or C:\\work\\project",
  "PC.Chat.LocalFiles.open": "Open",
  "PC.Chat.LocalFiles.cancel": "Cancel",
  "PC.Chat.LocalFiles.unavailableSuffix": " (unavailable)",
  "PC.Chat.LocalFiles.removeRoot": "Remove",
  "PC.Chat.LocalFiles.listFailed": "Failed to read local directory",
  "PC.Chat.LocalFiles.workspaceListFailed": "Failed to read project directory",
  "PC.Chat.LocalFiles.nameExists": "A file or directory with this name already exists",
  "PC.Chat.LocalFiles.deleteTitle": "Delete confirmation",
  "PC.Chat.LocalFiles.deleteWarning": "Permanently delete \"{name}\" on the session computer. This cannot be undone (it will not go to the trash).",
  "PC.Chat.LocalFiles.deleteConfirm": "Delete",
  "PC.Chat.LocalFiles.saveFailed": "Failed to save",
  "PC.Chat.LocalFiles.upToParent": "Go to parent directory",
