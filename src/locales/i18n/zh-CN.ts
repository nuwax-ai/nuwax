...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AgentFlowNode.agentIdEmpty": "暂无智能体",
  "PC.Pages.AgentFlowNode.extraPromptLabel": "补充提示词",
  "PC.Pages.AgentFlowNode.extraPromptPlaceholder": "可添加提示词约束智能体输出格式...",
  "PC.Pages.AgentFlowNode.extraPromptTooltip": "约束输出格式等，支持 {{变量}} 引用",
  "PC.Pages.AgentFlowNode.reminderPromptLabel": "循环提醒提示词",
  "PC.Pages.AgentFlowNode.reminderPromptPlaceholder": "循环提醒提示词...",
  "PC.Pages.AgentFlowNode.reminderPromptTooltip": "每次自循环结束后注入的提醒提示词，支持 {{变量}} 引用",
  "PC.Pages.AgentFlowNode.selfLoopTimesLabel": "自身循环次数",
  "PC.Pages.AgentFlowNode.selfLoopTimesTooltip": "智能体自循环执行的次数，0 表示不循环",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionLabel": "条件比对",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionPlaceholder": "输入条件比对表达式，支持 {{变量}} 引用",
  "PC.Pages.AgentFlowNode.routeDecisionRouteConditionTooltip": "用于精确比对的条件表达式，如 {{var}} == value",
