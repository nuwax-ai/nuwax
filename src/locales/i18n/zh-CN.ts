...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AgentFlowNode.agentModePlatform": "平台智能体",
  "PC.Pages.AgentFlowNode.agentModeSubFlow": "子流程",
  "PC.Pages.AgentFlowNode.answerTypeSelect": "选择",
  "PC.Pages.AgentFlowNode.answerTypeText": "文本",
  "PC.Pages.AgentFlowNode.approveActionApprove": "通过",
  "PC.Pages.AgentFlowNode.approveActionEdit": "编辑",
  "PC.Pages.AgentFlowNode.approveActionReject": "拒绝",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryContinue": "继续",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryFail": "失败",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryHuman": "转人工",
  "PC.Pages.AgentFlowNode.evalOnMaxRetryLabel": "最大重试时",
  "PC.Pages.AgentFlowNode.evalTypeLlmJudge": "LLM 评判",
  "PC.Pages.AgentFlowNode.evalTypeRule": "规则判断",
  "PC.Pages.AgentFlowNode.hitlModeApprove": "审批确认",
  "PC.Pages.AgentFlowNode.hitlModeAsk": "提问",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptLabel": "扩展指令",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptPlaceholder": "请输入给 AI 的额外路由决策指令...",
  "PC.Pages.AgentFlowNode.routeDecisionExtraPromptTooltip": "给 AI 模型的额外指令，帮助其做出更准确的路由判断",
  "PC.Pages.AgentFlowNode.routeDecisionRouteAdd": "添加路由规则",
  "PC.Pages.AgentFlowNode.routeDecisionRoutesTitle": "路由规则",
  "PC.Pages.AgentFlowNode.agentIdLabel": "平台智能体 ID",
  "PC.Pages.AgentFlowNode.agentIdPlaceholder": "请输入平台智能体 ID",
  "PC.Pages.AgentFlowNode.agentModeLabel": "智能体模式",
  "PC.Pages.AgentFlowNode.approveActionsLabel": "审批操作",
  "PC.Pages.AgentFlowNode.approveDraftSourceLabel": "草稿来源",
  "PC.Pages.AgentFlowNode.approveDraftSourceTooltip": "待审核草稿内容的模板表达式，如 {{node.<prevId>.output}}",
  "PC.Pages.AgentFlowNode.approvePromptLabel": "审核提示",
  "PC.Pages.AgentFlowNode.approvePromptPlaceholder": "请输入给审核人的指令...",
  "PC.Pages.AgentFlowNode.askAnswerKeyLabel": "回答键名",
  "PC.Pages.AgentFlowNode.askAnswerKeyTooltip": "存储用户回答的上下文键名，如 userAnswer",
  "PC.Pages.AgentFlowNode.askAnswerTypeLabel": "回答类型",
  "PC.Pages.AgentFlowNode.askOptionsLabel": "选项 (JSON)",
  "PC.Pages.AgentFlowNode.askOptionsTooltip": "选项 JSON 数组，如 [{\"index\":0,\"content\":\"选项A\",\"uuid\":\"...\"}]",
  "PC.Pages.AgentFlowNode.askQuestionLabel": "提问内容",
  "PC.Pages.AgentFlowNode.askQuestionPlaceholder": "请输入要向用户提出的问题...",
  "PC.Pages.AgentFlowNode.autoWireLabel": "自动接入上游输出",
  "PC.Pages.AgentFlowNode.autoWireTooltip": "自动将前一节点的输出作为本节点的输入",
  "PC.Pages.AgentFlowNode.connectorAuthCozeTooltip": "引用 Coze API Token，如 {{secrets.cozeToken}}",
  "PC.Pages.AgentFlowNode.connectorAuthDifyTooltip": "引用 Dify API Key，如 {{secrets.difyApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthN8nTooltip": "引用 n8n API Key 或 Webhook Secret，如 {{secrets.n8nApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthRagflowTooltip": "引用 Ragflow API Key，如 {{secrets.ragflowApiKey}}",
  "PC.Pages.AgentFlowNode.connectorAuthRefLabel": "鉴权引用",
  "PC.Pages.AgentFlowNode.connectorAuthRefPlaceholder": "{{secrets.apiKey}}",
  "PC.Pages.AgentFlowNode.connectorEndpointLabel": "端点 URL",
  "PC.Pages.AgentFlowNode.connectorPayloadTemplateLabel": "请求体模板",
  "PC.Pages.AgentFlowNode.connectorPayloadTemplateTooltip": "请求体的 JSON 模板，使用 {{context.xxx}} 引用运行时变量。",
  "PC.Pages.AgentFlowNode.connectorProviderLabel": "平台类型",
  "PC.Pages.AgentFlowNode.connectorResponseMappingAdd": "添加响应映射",
  "PC.Pages.AgentFlowNode.connectorResponseMappingTitle": "响应映射",
  "PC.Pages.AgentFlowNode.evalJudgeModelLabel": "评判模型 ID",
  "PC.Pages.AgentFlowNode.evalJudgePromptLabel": "评判提示词",
  "PC.Pages.AgentFlowNode.evalJudgePromptPlaceholder": "请输入 LLM 评判提示词...",
  "PC.Pages.AgentFlowNode.evalJudgeThresholdLabel": "阈值",
  "PC.Pages.AgentFlowNode.evalMaxRetryLabel": "最大重试次数",
  "PC.Pages.AgentFlowNode.evalOnFailAppendPromptLabel": "失败追加提示",
  "PC.Pages.AgentFlowNode.evalOnFailAppendPromptPlaceholder": "校验失败时追加的额外提示...",
  "PC.Pages.AgentFlowNode.evalOnFailReasonLabel": "失败原因",
  "PC.Pages.AgentFlowNode.evalOnFailReasonPlaceholder": "简要失败原因，如 format_invalid",
  "PC.Pages.AgentFlowNode.evalOnFailTargetLabel": "重试目标节点",
  "PC.Pages.AgentFlowNode.evalOnFailTargetTooltip": "校验失败时回跳到哪个节点重新执行",
  "PC.Pages.AgentFlowNode.evalRulePatternLabel": "规则模式",
  "PC.Pages.AgentFlowNode.evalRulePatternTooltip": "用于校验的正则表达式，如 ^ORDER-\\d+$",
  "PC.Pages.AgentFlowNode.evalValidatorAdd": "添加校验器",
  "PC.Pages.AgentFlowNode.evalValidatorIndex": "校验器 #{index}",
  "PC.Pages.AgentFlowNode.evalValidatorNameLabel": "校验器名称",
  "PC.Pages.AgentFlowNode.evalValidatorNamePlaceholder": "如 order_format_check",
  "PC.Pages.AgentFlowNode.evalValidatorTypeLabel": "校验器类型",
  "PC.Pages.AgentFlowNode.evalValidatorsTitle": "校验器列表",
  "PC.Pages.AgentFlowNode.hitlModeLabel": "交互模式",
  "PC.Pages.AgentFlowNode.routeDecisionRouteDescriptionLabel": "描述",
  "PC.Pages.AgentFlowNode.routeDecisionRouteDescriptionPlaceholder": "描述何时应选择此路由...",
  "PC.Pages.AgentFlowNode.routeDecisionRouteIndex": "路由 #{index}",
  "PC.Pages.AgentFlowNode.routeDecisionRouteNameLabel": "路由名称",
  "PC.Pages.AgentFlowNode.routeDecisionRouteNamePlaceholder": "如 complaint_handling",
  "PC.Pages.AgentFlowNode.subFlowIdLabel": "子流程 ID",
  "PC.Pages.AgentFlowNode.subFlowIdPlaceholder": "请输入子流程 ID",
  "PC.Pages.AgentFlowNode.agentInputsTitle": "输入映射",
  "PC.Pages.AgentFlowNode.agentInputsAdd": "添加输入",
  "PC.Pages.AgentFlowNode.askRequiredLabel": "是否必答",
  "PC.Pages.AgentFlowNode.askRequiredTooltip": "用户必须回答后才能继续",
  "PC.Pages.AgentFlowNode.approveOnRejectTargetLabel": "拒绝目标节点",
  "PC.Pages.AgentFlowNode.approveOnRejectTargetTooltip": "拒绝时跳转的节点 ID；留空则终止运行",
  "PC.Pages.AgentFlowNode.approvalModeAlwaysPass": "仅通知（自动通过）",
  "PC.Pages.AgentFlowNode.approvalModeApproveReject": "通过 / 拒绝",
  "PC.Pages.AgentFlowNode.approvalModeEditApprove": "可编辑后通过",
  "PC.Pages.AgentFlowNode.approvalModeLabel": "审核模式",
  "PC.Pages.AgentFlowNode.approveBranchAdd": "+ 添加分支",
  "PC.Pages.AgentFlowNode.approveBranchesTitle": "输出分支",
  "PC.Pages.AgentFlowNode.askOptionsTitle": "选项内容",
  "PC.Pages.AgentFlowNode.askTimeoutLabel": "超时时间（秒）",
  "PC.Pages.AgentFlowNode.askTimeoutPlaceholder": "请输入超时时间",
  "PC.Pages.AgentFlowNode.baseParamLabel": "基础参数",
  "PC.Pages.AgentFlowNode.branchDescPlaceholder": "描述",
  "PC.Pages.AgentFlowNode.branchNamePlaceholder": "分支名称",
  "PC.Pages.AgentFlowNode.channelAdd": "+ 添加通道",
  "PC.Pages.AgentFlowNode.channelRetryLabel": "重试次数",
  "PC.Pages.AgentFlowNode.channelTimeoutLabel": "通道超时（秒）",
  "PC.Pages.AgentFlowNode.channelsTitle": "确认通道",
  "PC.Pages.AgentFlowNode.confirmRoleExternal": "外部确认",
  "PC.Pages.AgentFlowNode.confirmRoleLabel": "确认角色",
  "PC.Pages.AgentFlowNode.confirmRoleUser": "使用者确认",
  "PC.Pages.AgentFlowNode.contextPassAuto": "自动",
  "PC.Pages.AgentFlowNode.contextPassManual": "手动",
  "PC.Pages.AgentFlowNode.contextWriteKeyHint": "输出写入的上下文键名，如 evalResult",
  "PC.Pages.AgentFlowNode.contextPassModeLabel": "上下文传递",
  "PC.Pages.AgentFlowNode.escalationAbort": "中止工作流",
  "PC.Pages.AgentFlowNode.escalationLabel": "超时处理",
  "PC.Pages.AgentFlowNode.escalationReject": "自动拒绝",
  "PC.Pages.AgentFlowNode.escalationRetry": "重新通知审核人",
  "PC.Pages.AgentFlowNode.escalationSkip": "跳过（自动通过）",
  "PC.Pages.AgentFlowNode.evalBranchAdd": "+ 添加不通过分支",
  "PC.Pages.AgentFlowNode.evalBranchesTitle": "评估分支",
  "PC.Pages.AgentFlowNode.evalFailMsgLabel": "超限未通过提示",
  "PC.Pages.AgentFlowNode.evalFailMsgPlaceholder": "智能体输出结果评估未通过，请仔细甄别",
  "PC.Pages.AgentFlowNode.evalItemAdd": "+ 添加评估项",
  "PC.Pages.AgentFlowNode.evalItemDescLabel": "评估标准",
  "PC.Pages.AgentFlowNode.evalItemDescPlaceholder": "评估标准描述",
  "PC.Pages.AgentFlowNode.evalItemIndex": "评估项 {{index}}",
  "PC.Pages.AgentFlowNode.evalItemNameLabel": "项目名称",
  "PC.Pages.AgentFlowNode.evalItemNamePlaceholder": "准确性",
  "PC.Pages.AgentFlowNode.evalItemsTitle": "评估项目",
  "PC.Pages.AgentFlowNode.evalItemWeightLabel": "权重",
  "PC.Pages.AgentFlowNode.evalModelLabel": "评估模型",
  "PC.Pages.AgentFlowNode.evalModelPlaceholder": "选择评估模型",
  "PC.Pages.AgentFlowNode.evalOutputLabel": "评估过程输出",
  "PC.Pages.AgentFlowNode.evalWeightTotalLabel": "权重合计",
  "PC.Pages.AgentFlowNode.extraParamsAdd": "+ 添加参数",
  "PC.Pages.AgentFlowNode.extraParamsTitle": "自定义参数",
  "PC.Pages.AgentFlowNode.formFieldAdd": "+ 添加字段",
  "PC.Pages.AgentFlowNode.formFieldIndex": "字段 {0}",
  "PC.Pages.AgentFlowNode.formFieldLabel": "字段标签",
  "PC.Pages.AgentFlowNode.formFieldLabelPlaceholder": "请输入字段标签",
  "PC.Pages.AgentFlowNode.formFieldType": "字段类型",
  "PC.Pages.AgentFlowNode.formFieldOptions": "选项列表",
  ...
  "PC.Pages.AgentFlowNode.formTypeFile": "文件",
  ...
  "PC.Pages.AgentFlowNode.instructionLabel": "审核说明",
  "PC.Pages.AgentFlowNode.instructionPlaceholder": "向审核人说明需要确认的内容...",
  "PC.Pages.AgentFlowNode.optionAdd": "+ 添加选项",
  "PC.Pages.AgentFlowNode.optionContentPlaceholder": "请输入选项内容",
  "PC.Pages.AgentFlowNode.passThresholdLabel": "通过阈值",
  "PC.Pages.AgentFlowNode.passThresholdSuffix": "分",
  "PC.Pages.AgentFlowNode.replyModeForm": "表单",
  "PC.Pages.AgentFlowNode.replyModeLabel": "回复模式",
  "PC.Pages.AgentFlowNode.replyModeOptions": "选项",
  "PC.Pages.AgentFlowNode.replyModeText": "文本",
  "PC.Pages.AgentFlowNode.routeModelLabel": "识别模型",
  "PC.Pages.AgentFlowNode.routeModelPlaceholder": "选择识别模型",
  "PC.Pages.AgentFlowNode.shareContextLabel": "共用上游智能体上下文",
  "PC.Pages.AgentFlowNode.systemPromptLabel": "补充提示词",
  "PC.Pages.AgentFlowNode.systemPromptPlaceholder": "可添加提示词约束智能体输出格式...",
  "PC.Pages.AgentFlowNode.systemPromptTooltip": "约束输出格式等，支持 {{变量}} 引用",
