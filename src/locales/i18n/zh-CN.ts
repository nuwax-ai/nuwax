...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Components.ChatInputHome.slashCapability": "使用 / 选择能力",
  ...
  "PC.Components.ModelSelector.addPersonalModel": "个人模型",
  ...
  "PC.Pages.AppDevPro.databaseDev": "开发环境数据库",
  "PC.Pages.AppDevPro.databaseDevConfig": "开发环境数据库设置",
  "PC.Pages.AppDevPro.databaseProd": "线上环境数据库",
  "PC.Pages.AppDevPro.databaseProdConfig": "线上环境数据库设置",
  "PC.Pages.AppDevPro.databaseConfigDesc": "查看和配置当前环境的数据库账号和密码",
  "PC.Pages.AppDevPro.databaseProdDesc": "查看和管理线上环境数据库",
  "PC.Pages.AppDevPro.databaseProdConfigDesc": "查看和配置线上环境的数据库账号和密码",
  ...
  "PC.Pages.AppDevPro.prodContainerStarting": "正在启动线上环境...",
  "PC.Pages.AppDevPro.prodContainerFailed": "线上环境启动失败",
  "PC.Pages.AppDevPro.prodContainerRetry": "重新启动",
  ...
  "PC.Pages.AppDevPro.tabTerminalDev": "终端（开发环境）",
  "PC.Pages.AppDevPro.tabTerminalProd": "终端（线上环境）",
  ...
  "PC.Pages.AppDevPro.publishToMarketStep": "发布应用到广场",
  "PC.Pages.AppDevPro.publishToMarketHint": "请完成发布到广场",
  "PC.Pages.AppDevPro.reopenPublishToMarket": "继续发布到广场",
  "PC.Pages.AppDevPro.publishToSquareNote": "（已部署成功，用户可自行决定是否需要发布到广场）",
  ...
  "PC.Pages.AppDevPro.restartService": "重启服务",
  ...
  // 全栈应用设置页
  // 顶部 Tab
  "PC.Pages.AppProjectSetting.tabPlan": "计划",
  "PC.Pages.AppProjectSetting.tabAsset": "资产",
  "PC.Pages.AppProjectSetting.tabSetting": "设置",
  "PC.Pages.AppProjectSetting.comingSoon": "功能即将开放",
  // OAuth2 认证
  "PC.Pages.AppProjectSetting.oauthTitle": "OAuth2 认证信息",
  "PC.Pages.AppProjectSetting.oauthDesc": "平台已为该项目自动生成 OAuth2 凭证，可用于第三方登录与接口鉴权。Client Secret 属于敏感信息，请勿写入前端或提交到公开仓库。",
  "PC.Pages.AppProjectSetting.clientId": "Client ID",
  "PC.Pages.AppProjectSetting.clientSecret": "Client Secret",
  "PC.Pages.AppProjectSetting.homeUrl": "主页地址",
  "PC.Pages.AppProjectSetting.homeUrlPlaceholder": "请输入主页地址",
  "PC.Pages.AppProjectSetting.callbackUrl": "回调地址",
  "PC.Pages.AppProjectSetting.callbackUrlPlaceholder": "请输入回调地址",
  "PC.Pages.AppProjectSetting.regenerate": "重新生成凭证",
  "PC.Pages.AppProjectSetting.regenerateHint": "重新生成后旧凭证立即失效，需同步更新已接入的应用。",
  "PC.Pages.AppProjectSetting.regenerateConfirmTitle": "确认重新生成凭证",
  "PC.Pages.AppProjectSetting.regenerateSuccess": "凭证已重新生成",
  "PC.Pages.AppProjectSetting.regenerateUnavailable": "重新生成凭证暂未开放",
  // 域名绑定
  "PC.Pages.AppProjectSetting.domainTitle": "域名绑定",
  "PC.Pages.AppProjectSetting.domainDesc": "绑定自有域名后，可通过该域名访问已发布的应用。请在域名服务商处添加 CNAME 记录指向 {0}，解析生效后状态会自动更新。",
  "PC.Pages.AppProjectSetting.cnameLabel": "CNAME",
  "PC.Pages.AppProjectSetting.copyCname": "复制CNAME",
  "PC.Pages.AppProjectSetting.bindDomain": "绑定域名",
  "PC.Pages.AppProjectSetting.domainPlaceholder": "请输入域名，如 app.example.com",
  "PC.Pages.AppProjectSetting.domainBound": "已绑定",
  // 发布服务器配置
  "PC.Pages.AppProjectSetting.deployTitle": "发布服务器配置",
  "PC.Pages.AppProjectSetting.deployDesc": "选择应用发布后的运行位置。选择私有服务器时，需提供访问协议、服务器地址与两个端口。",
  "PC.Pages.AppProjectSetting.platformService": "平台服务",
  "PC.Pages.AppProjectSetting.platformServiceDesc": "由女娲平台托管运行，免运维，自动弹性伸缩",
  "PC.Pages.AppProjectSetting.privateServer": "私有服务器",
  "PC.Pages.AppProjectSetting.privateServerDesc": "部署到自有服务器，需配置协议、IP 与两个端口",
  "PC.Pages.AppProjectSetting.platformHint": "当前由平台托管运行，无需填写服务器信息。切换为私有服务器后可配置协议、IP 与端口。",
  "PC.Pages.AppProjectSetting.protocol": "协议",
  "PC.Pages.AppProjectSetting.protocolHttp": "http",
  "PC.Pages.AppProjectSetting.protocolHttps": "https",
  "PC.Pages.AppProjectSetting.serverIp": "服务器 IP",
  "PC.Pages.AppProjectSetting.serverIpPlaceholder": "例如 47.98.12.34",
  "PC.Pages.AppProjectSetting.appPort": "应用端口",
  "PC.Pages.AppProjectSetting.appPortPlaceholder": "例如 8080",
  "PC.Pages.AppProjectSetting.managePort": "管理端口",
  "PC.Pages.AppProjectSetting.managePortPlaceholder": "例如 8081",
  "PC.Pages.AppProjectSetting.privateHint": "应用端口用于对外提供访问，管理端口用于平台下发部署与健康检查。请确保服务器可被平台访问，并已在安全组放通上述端口。选择 HTTPS 时，需在服务器上部署有效证书并监听应用端口，平台不代管证书。",
  // 相关任务
  "PC.Pages.AppProjectSetting.conversationTitle": "相关任务",
  "PC.Pages.AppProjectSetting.newConversation": "新建任务",
  "PC.Pages.AppProjectSetting.emptyConversation": "暂无会话",
  "PC.Pages.AppProjectSetting.mine": "我的",
  "PC.Pages.AppProjectSetting.today": "今天",
  // 空态与提示
  "PC.Pages.AppProjectSetting.notFound": "未找到该项目",
  "PC.Pages.AppProjectSetting.untitled": "未命名项目",
  "PC.Pages.AppProjectSetting.emptyValue": "—",
  "PC.Pages.AppProjectSetting.bindSuccess": "域名绑定成功",
  "PC.Pages.AppProjectSetting.unbindSuccess": "已解除绑定",
  ...
  "PC.Pages.AppProjectSetting.addPrivateServer": "添加私有服务器",
  "PC.Pages.AppProjectSetting.addServerRow": "添加",
  "PC.Pages.AppProjectSetting.addPrivateServerSuccess": "私有服务器已添加",
  "PC.Pages.AppProjectSetting.deletePrivateServerTitle": "删除私有服务器",
  "PC.Pages.AppProjectSetting.deletePrivateServerContent": "确定要删除 {0} 吗？",
  "PC.Pages.AppProjectSetting.invalidServerIp": "请输入服务器地址",
  "PC.Pages.AppProjectSetting.invalidPort": "请输入 1-65535 之间的端口",
  "PC.Pages.AppProjectSetting.healthOnline": "在线",
  "PC.Pages.AppProjectSetting.healthOffline": "离线",
  ...
  'PC.Components.CapabilityModal.mainTabConnected': '已连接',
  ...
  'PC.Components.CapabilityModal.hintNav': '方向键移动',
  'PC.Components.CapabilityModal.hintSelect': '回车选中',
  'PC.Components.CapabilityModal.hintClose': 'Esc 关闭',
