...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AgentArrangeCreateHookModal.cancel": "取消",
  "PC.Pages.AgentArrangeCreateHookModal.config": "配置 JSON",
  "PC.Pages.AgentArrangeCreateHookModal.configHint": "示例：{ \"type\": \"{0}\", \"command\": \"脚本路径\", \"args\": [] }",
  ...
  "PC.Pages.AgentArrangeCreateHookModal.matcherHint": "可选：工具名称，如 Bash、Edit|Write、mcp__.*",
