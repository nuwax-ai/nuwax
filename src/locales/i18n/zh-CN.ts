...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Chat.LocalFiles.workspaceLabel": "项目目录",
  "PC.Chat.LocalFiles.openLocalDirectory": "打开本地目录…",
  "PC.Chat.LocalFiles.openByPathTitle": "打开本地目录",
  "PC.Chat.LocalFiles.openByPathHint": "输入会话所在电脑上的目录绝对路径",
  "PC.Chat.LocalFiles.pathPlaceholder": "例如 /Users/me/docs 或 C:\\work\\project",
  "PC.Chat.LocalFiles.open": "打开",
  "PC.Chat.LocalFiles.cancel": "取消",
  "PC.Chat.LocalFiles.unavailableSuffix": "（不可用）",
  "PC.Chat.LocalFiles.removeRoot": "移除",
  "PC.Chat.LocalFiles.listFailed": "本地目录读取失败",
  "PC.Chat.LocalFiles.workspaceListFailed": "项目目录读取失败",
  "PC.Chat.LocalFiles.nameExists": "同名文件或目录已存在",
  "PC.Chat.LocalFiles.deleteTitle": "删除确认",
  "PC.Chat.LocalFiles.deleteWarning": "将在会话电脑上永久删除「{name}」，此操作不可恢复（不进入回收站）。",
  "PC.Chat.LocalFiles.deleteConfirm": "删除",
  "PC.Chat.LocalFiles.saveFailed": "保存失败",
  "PC.Chat.LocalFiles.upToParent": "返回上级目录",
