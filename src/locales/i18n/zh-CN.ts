...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AppDevPro.containerStarting": "容器启动中…",
  "PC.Pages.AppDevPro.containerStartingHint": "容器启动成功后将继续准备应用预览",
  "PC.Pages.AppDevPro.containerStartFailed": "容器启动失败",
  "PC.Pages.AppDevPro.containerStartFailedHint": "请重新启动容器后再继续",
  "PC.Pages.AppDevPro.containerStartRetry": "重新启动容器",
