...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.ConversationAgentSourceControl.commitMessage": "提交信息（可选）",
  ...
  "PC.Pages.ConversationAgentPreviewTabBar.theme": "切换主题",
  "PC.Pages.ConversationAgentPreviewTabBar.sourceControl": "源代码管理",
  "PC.Pages.ConversationAgentPreviewTabBar.splitView": "分屏",
  "PC.Pages.ConversationAgentPreviewTabBar.openExternal": "在外部打开",
  ...
  "PC.Pages.ConversationAgentTabPicker.integratedServices": "集成服务",
  "PC.Pages.ConversationAgentTabPicker.integratedServicesDesc": "快速配置数据库、身份验证、存储等后端基础设施，为应用赋能底层能力。",
  "PC.Pages.ConversationAgentTabPicker.hosting": "托管",
  ...
  "PC.Pages.ConversationAgentTabPicker.integrationMgmt": "集成管理",
  "PC.Pages.ConversationAgentTabPicker.integrationMgmtDesc": "配置模型能力、外部 API 和项目所需的各类后端服务资源。",
  "PC.Pages.ConversationAgentTabPicker.envVars": "环境变量",
  "PC.Pages.ConversationAgentTabPicker.envVarsDesc": "安全存储 API Key 等配置信息。",
  "PC.Pages.ConversationAgentTabPicker.database": "数据库",
  "PC.Pages.ConversationAgentTabPicker.databaseDesc": "查看和管理项目中的结构化数据。",
  "PC.Pages.ConversationAgentTabPicker.auth": "身份验证",
  "PC.Pages.ConversationAgentTabPicker.authDesc": "快速配置用户登录、注册和权限管理。",
  "PC.Pages.ConversationAgentTabPicker.objectStorage": "对象存储",
  "PC.Pages.ConversationAgentTabPicker.objectStorageDesc": "存储图片、视频、文档等非结构化文件资源。",
