...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AppDevPro.cancelPublishContent": "取消后将停止当前构建任务，不会提交发布申请",
  "PC.Pages.AppDevPro.cancelPublishTitle": "确认取消发布？",
  "PC.Pages.AppDevPro.clickToCancelPublish": "点击取消发布",
