...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.SpaceCreateProject.greetingTitle": "嗨，{0}，给我一个任务，现在开始？",
  "PC.Pages.SpaceCreateProject.tabAgent": "智能体",
  "PC.Pages.SpaceCreateProject.placeholderAgent": "描述你想要的智能体，例如：帮我创建一个代码审查助手，能自动检测代码问题并给出优化建议",
  "PC.Pages.SpaceCreateProject.tabPageApp": "网页应用",
  "PC.Pages.SpaceCreateProject.placeholderPageApp": "描述你想要的网页应用，例如：帮我开发一个颜值管理网站，支持上传照片智能评估颜值与肤质",
  "PC.Pages.SpaceCreateProject.tabSkill": "技能",
  "PC.Pages.SpaceCreateProject.placeholderSkill": "描述你想要的自定义技能，例如：帮我写一个根据经纬度查询当前天气状况的API接口",
