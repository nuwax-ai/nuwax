...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Components.ChatInputCommands.choose": "试试 / 选择技能或插件",
  ...
  "PC.Components.ChatInputCommands.hint": "直接输入指令，Shift+Enter 换行，回车发送；输入 / 选择技能或插件；支持粘贴图片",
  ...
  "PC.Components.LocalFiles.workspaceLabel": "项目目录",
  "PC.Components.LocalFiles.openLocalDirectory": "打开本地目录…",
  "PC.Components.LocalFiles.openByPathTitle": "打开本地目录",
  "PC.Components.LocalFiles.openByPathHint": "输入会话所在电脑上的目录绝对路径",
  "PC.Components.LocalFiles.pathPlaceholder": "例如 /Users/me/docs 或 C:\\work\\project",
  "PC.Components.LocalFiles.open": "打开",
  "PC.Components.LocalFiles.cancel": "取消",
  "PC.Components.LocalFiles.unavailableSuffix": "（不可用）",
  "PC.Components.LocalFiles.removeRoot": "移除",
  "PC.Components.LocalFiles.listFailed": "本地目录读取失败",
  "PC.Components.LocalFiles.workspaceListFailed": "项目目录读取失败",
  "PC.Components.LocalFiles.nameExists": "同名文件或目录已存在",
  "PC.Components.LocalFiles.deleteTitle": "删除确认",
  "PC.Components.LocalFiles.deleteWarning": "将在会话电脑上永久删除「{name}」，此操作不可恢复（不进入回收站）。",
  ...
  "PC.Components.PathPreview.open": "按路径打开文件",
  "PC.Components.PathPreview.path": "文件路径",
  "PC.Components.PathPreview.hint": "输入相对当前所选根目录的文件路径，如 .gitignore 或 docs/说明.md",
  "PC.Components.PathPreview.preview": "预览",
  "PC.Components.PathPreview.error.path": "请输入有效的相对文件路径；绝对路径请先切换对应目录",
  "PC.Components.PathPreview.error.missing": "文件不存在，请检查路径",
  "PC.Components.PathPreview.error.denied": "没有权限读取此文件，请检查登录状态和文件权限",
  "PC.Components.PathPreview.error.load": "文件读取失败，请重试",
  // 专家·技能·连接器框架页
