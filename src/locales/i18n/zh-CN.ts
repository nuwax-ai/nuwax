...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.ConversationAgent.gitPush.failed": "Git 推送失败，请检查配置后重试",
  "PC.Pages.ConversationAgent.gitPush.noConversation": "无活跃会话，无法执行 Git 推送",
  "PC.Pages.ConversationAgent.gitPush.saveFailed": "文件保存失败，无法执行 Git 推送",
  ...
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.viewChanges": "查看变更",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.rollback": "回滚",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.viewChangesTip": "请在源代码管理或文件预览中查看具体变更",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.rollbackConfirmTitle": "确认回滚？",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.rollbackConfirmContent": "将代码回滚到提交 {0}，此操作可能覆盖当前未提交的修改。",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.rollbackSuccess": "回滚成功",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.rollbackFailed": "回滚失败，请稍后重试",
  "PC.Pages.ConversationAgent.AgentGitVersionRecord.loadFailed": "加载提交记录失败",
  ...
  "PC.Pages.ConversationAgentBottomConsole.collapsePanel": "折叠到底部",
  "PC.Pages.ConversationAgentBottomConsole.expandHeight": "放大至全屏",
  "PC.Pages.ConversationAgentBottomConsole.restoreHeight": "恢复默认高度",
  "PC.Pages.ConversationAgentBottomConsole.terminalThemeDark": "切换为深色终端",
  "PC.Pages.ConversationAgentBottomConsole.terminalThemeLight": "切换为浅色终端",
