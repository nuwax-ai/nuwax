...
export const ZH_CN: SystemLangMap = {
  ...
  "PC.Pages.AppDevSettingsModal.reusePlatformAuth": "复用平台认证",
  "PC.Pages.AppDevSettingsModal.reusePlatformAuthDesc": "开启后可在 header 中获取当前登录用户的 uid、用户名、昵称，可以用于业务系统唯一性识别。",
