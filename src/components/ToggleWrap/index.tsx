 ...
 * 容器组件
 */
const ToggleWrap: React.FC<PropsWithChildren<ToggleWrapProps>> = ({className, title, visible, onClose, children}) => {
  return (
    <div
      className={cx(
        'flex',
    ...
    >
      <div className={cx(styles.header, 'flex', 'items-center', 'content-between')}>
        <h3>{title}</h3>
        <CloseOutlined
