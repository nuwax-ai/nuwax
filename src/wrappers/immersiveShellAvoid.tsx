 ...
 * - 沉浸态：两层 div 挂 .immersive-shell-page / -inner，全部几何在
 *   styles/immersiveShell.less（CSS 变量消费，本组件零内联样式、零尺寸数字）。
...
import { isImmersiveShell, syncShellAvoidanceCss } from '@/utils/hostBridge';
...
export default function ImmersiveShellAvoid() {
  ...
  return (
    <div className="immersive-shell-page">
      <div className="immersive-shell-page-inner">
        <Outlet />
      </div>
    </div>
  );
